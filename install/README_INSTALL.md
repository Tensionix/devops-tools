# Audion DevOps Tools - install notes
...
Portable PowerShell is not required by the project core. It is useful for fully portable GUI picker dialogs and build helper scripts.
...
GUI-specific runtime checks are covered by `system_core\doctor.py` and `system_core\ui_nicegui\app.py --smoke`.
