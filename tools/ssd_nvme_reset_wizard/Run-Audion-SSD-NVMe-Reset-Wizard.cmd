...
set "SCRIPT_DIR=%~dp0"
set "PS1_FILE=%SCRIPT_DIR%Audion-SSD-NVMe-Reset-Wizard.ps1"
set "PS_ENGINE="
set "EXITCODE=0"
...
if exist "%SCRIPT_DIR%system_core\powershell\pwsh.exe" set "PS_ENGINE=%SCRIPT_DIR%system_core\powershell\pwsh.exe" & exit /b 0
if exist "S:\Audion\TOOLS\PowerShell\pwsh.exe" set "PS_ENGINE=S:\Audion\TOOLS\PowerShell\pwsh.exe" & exit /b 0
if exist "E:\Audion\TOOLS\PowerShell\pwsh.exe" set "PS_ENGINE=E:\Audion\TOOLS\PowerShell\pwsh.exe" & exit /b 0
