# Instruction-E — WSL на рабочем ПК (`E:\WSL`)
...
Это установка Ubuntu в нужную рабочую папку на диске `E:`.
...
### 5.1. Если bootstrap лежит на Windows-диске `E:`
...
```bash
chmod +x /mnt/e/Audion-Linux-Bootstrap/Ubuntu-Desktop/bootstrap_ubuntu_minimal.sh
```

Запустить базовый Ubuntu-скрипт.

```bash
/mnt/e/Audion-Linux-Bootstrap/Ubuntu-Desktop/bootstrap_ubuntu_minimal.sh
```

Дать право на запуск расширенному Ubuntu-скрипту.

```bash
chmod +x /mnt/e/Audion-Linux-Bootstrap/Ubuntu-Desktop/bootstrap_ubuntu_power.sh
```

Запустить расширенный Ubuntu-скрипт.

```bash
/mnt/e/Audion-Linux-Bootstrap/Ubuntu-Desktop/bootstrap_ubuntu_power.sh
```
...
## 6. Практический рекомендуемый сценарий для рабочего ПК
