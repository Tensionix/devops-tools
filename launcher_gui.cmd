...
echo [INFO] Audion DevOps Tools requires Administrator rights.
...
echo.
echo Build the portable GUI runtime first or run this launcher from a real project folder.
echo Set AUDION_GUI_CONSOLE=1 to run GUI in console debug mode.
echo Set AUDION_GUI_NO_ELEVATE=1 to skip the startup UAC elevation.
if not defined AUDION_NO_PAUSE pause
exit /b 1
